...
QT_MOC_LITERAL(5, 57, 17), // "receiveAddedWords"
QT_MOC_LITERAL(6, 75, 5) // "count"

    },
    "QuestionWidget\0sendQuestionWordList\0"
    "\0QVector<Word>\0words\0receiveAddedWords\0"
    "count"
};
...
void QuestionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendQuestionWordList((*reinterpret_cast< QVector<Word>(*)>(_a[1]))); break;
        case 1: _t->receiveAddedWords((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QuestionWidget::*)(QVector<Word> );
...
// SIGNAL 0
void QuestionWidget::sendQuestionWordList(QVector<Word> _t1)
{
